...
download_directory = os.path.expanduser("/Users/kelvin/CS506 Mass CS Data/datafromwebcrawler")
...
# URL of the website
url = "https://profiles.doe.mass.edu/statereport/ap_part.aspx"
driver.get(url)
...
for year_option in years:
    ...
    for group_abbr, group in student_groups.items():
        ...
        file_path = os.path.join(download_directory, 'ap_participation.xlsx')
        ...
        # Define the paths
        excel_file = os.path.join(download_directory, "ap_participation.xlsx")
        csv_file = os.path.join(download_directory, year_option, f"{year_option[2:]}_AP_CS_Participation_{group}.csv")
